package com.github.felipecamilo.citiesapi.cities.service;

import com.github.felipecamilo.citiesapi.cities.entities.City;
import com.github.felipecamilo.citiesapi.cities.repositories.CityRepository;
...
public class DistanceService {
  ...
  public Double distanceUsingPoints(final Long city1, final Long city2, final com.github.andrelugomes.cities.service.EarthRadius unit) {
  ...
  private double doCalculation(final double lat1, final double lon1, final double lat2,
                               final double lng2, final com.github.andrelugomes.cities.service.EarthRadius earthRadius) {
